...
function App() {
    ...
    <form title="signup" onSubmit={submitForm}>
      ...
      <div>
        ...
        <input
          ...
          onChange={updateInterests}
        />
        <label htmlFor="interest2">Politics</label>
        <input
          type="checkbox"
          id="interest3"
          ...
          onChange={updateInterests}
        />
        <label htmlFor="interest3">News</label>
      </div>
  ...
  const displayMessage = (
    <div>
      ...
      <ul>
        {interests.interest1 ? <li>Sports</li> : null}
        {interests.interest2 ? <li>Politics</li> : null}
        {interests.interest3 ? <li>News</li> : null}
      </ul>
    </div>
  );
