...
test("the checkboxes are initially unchecked", () => {
  ...
  expect(
    screen.getByRole("checkbox", { name: /politics/i })
  ).not.toBeChecked();
  expect(
    screen.getByRole("checkbox", { name: /news/i })
  ).not.toBeChecked();
});
...
test("checked status of checkboxes changes when user clicks them", () => {
  ...
  const interest1 = screen.getByRole("checkbox", { name: /sports/i });
  const interest2 = screen.getByRole("checkbox", { name: /politics/i });
  const interest3 = screen.getByRole("checkbox", { name: /news/i });
...
test("a message is displayed when the user clicks the Submit button", () => {
  ...
  userEvent.click(screen.getByRole("checkbox", { name: /sports/i }));
  userEvent.click(screen.getByRole("checkbox", { name: /news/i }));
